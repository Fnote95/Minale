...
<div style="z-index:1;position:relative;">
	<img src="pizza.png" id="loading" style="width: 500px; height: auto; margin-left: -250px ;opacity: 0.8" >
</div>

	<div class="text-right" style="z-index:2;position:relative;width: 100vw;">
		<img src="fish.png" id="loading" style="width: 250px; height: auto; opacity: 0.8; margin-top: -250px;margin-right: -125px;">
	</div>
